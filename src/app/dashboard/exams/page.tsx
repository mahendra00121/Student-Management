            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-2">
                <Card className="bg-primary/5 border-none shadow-none">
                    <CardHeader className="pb-2">
                        <CardDescription className="text-[10px] uppercase font-black tracking-widest text-primary/70">Total Scheduled</CardDescription>
                        <CardTitle className="text-2xl font-black">{stats.total}</CardTitle>
                    </CardHeader>
                </Card>
                <Card className="bg-emerald-500/5 border-none shadow-none">
                    <CardHeader className="pb-2">
                        <CardDescription className="text-[10px] uppercase font-black tracking-widest text-emerald-600/70">Currently Ongoing</CardDescription>
                        <CardTitle className="text-2xl font-black">{stats.ongoing}</CardTitle>
                    </CardHeader>
                </Card>
                <Card className="bg-amber-500/5 border-none shadow-none">
                    <CardHeader className="pb-2">
                        <CardDescription className="text-[10px] uppercase font-black tracking-widest text-amber-600/70">Upcoming Sessions</CardDescription>
                        <CardTitle className="text-2xl font-black">{stats.upcoming}</CardTitle>
                    </CardHeader>
                </Card>
                <Card className="bg-violet-500/5 border-none shadow-none">
                    <CardHeader className="pb-2">
                        <CardDescription className="text-[10px] uppercase font-black tracking-widest text-violet-600/70">Recently Completed</CardDescription>
                        <CardTitle className="text-2xl font-black">{stats.completed}</CardTitle>
                    </CardHeader>
                </Card>
            </div>

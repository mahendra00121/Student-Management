    ...
    return (
        <div className="flex flex-col gap-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                <Card className="bg-primary/5 border-none shadow-none overflow-hidden relative group">
                    ...
                    <CardHeader className="pb-2">
                        <CardDescription className="text-[10px] uppercase font-black tracking-widest text-primary/70">Candidates</CardDescription>
                        <CardTitle className="text-3xl font-black">{stats.total}</CardTitle>
                    </CardHeader>
                    <CardContent>
                        <div className="text-[10px] font-black uppercase tracking-wider text-muted-foreground flex items-center gap-1">
                            <Activity className="h-3 w-3" /> Total evaluations
                        </div>
                    </CardContent>
                </Card>
                <Card className="bg-emerald-500/5 border-none shadow-none overflow-hidden relative group">
                    <CardHeader className="pb-2">
                        <CardDescription className="text-[10px] uppercase font-black tracking-widest text-emerald-600/70">Successful</CardDescription>
                        <CardTitle className="text-3xl font-black text-emerald-600">{stats.passed}</CardTitle>
                    </CardHeader>
                    <CardContent>
                        <div className="text-[10px] font-black uppercase tracking-wider text-emerald-600/70 flex items-center gap-1">
                            <CheckCircle2 className="h-3 w-3" /> Qualified students
                        </div>
                    </CardContent>
                </Card>
                <Card className="bg-rose-500/5 border-none shadow-none overflow-hidden relative group">
                    <CardHeader className="pb-2">
                        <CardDescription className="text-[10px] uppercase font-black tracking-widest text-rose-600/70">Unsuccessful</CardDescription>
                        <CardTitle className="text-3xl font-black text-rose-600">{stats.failed}</CardTitle>
                    </CardHeader>
                    <CardContent>
                        <div className="text-[10px] font-black uppercase tracking-wider text-rose-600/70 flex items-center gap-1">
                            <XCircle className="h-3 w-3" /> Re-evaluation needed
                        </div>
                    </CardContent>
                </Card>
                <Card className="bg-violet-500/5 border-none shadow-none overflow-hidden relative group">
                    <CardHeader className="pb-2">
                        <CardDescription className="text-[10px] uppercase font-black tracking-widest text-violet-600/70">Pass Index</CardDescription>
                        <CardTitle className="text-3xl font-black text-violet-600">{Math.round(stats.passPct)}%</CardTitle>
                    </CardHeader>
                    <CardContent>
                        <div className="text-[10px] font-black uppercase tracking-wider text-violet-600/70 flex items-center gap-1">
                            <TrendingUp className="h-3 w-3" /> Growth trajectory
                        </div>
                    </CardContent>
                </Card>
            </div>

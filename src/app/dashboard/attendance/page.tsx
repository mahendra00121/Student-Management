        ...
        <div className="flex flex-col gap-8">
            <header className="flex flex-col gap-2">
                <div className="flex items-center gap-2 mb-1">
                    ...
                    <span className="text-xs font-black uppercase tracking-widest text-primary/70">Presence Monitoring</span>
                </div>
                <h1 className="text-4xl font-black tracking-tighter">Attendance Management</h1>

    ...
    return (
        <div className="flex flex-col gap-6">
            <header className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                <div>
                    <h1 className="text-3xl font-black tracking-tighter">Faculty Management</h1>
                    <p className="text-muted-foreground text-sm font-medium">Coordinate and manage institutional teaching staff and their assignments.</p>
                </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-2">
                <Card className="bg-indigo-500/5 border-none shadow-none">
                    <CardHeader className="pb-2">
                        <CardDescription className="text-[10px] uppercase font-bold tracking-widest text-indigo-600/70">Total Faculty</CardDescription>
                        <CardTitle className="text-2xl font-black">{teachers.length}</CardTitle>
                    </CardHeader>
                </Card>
                <Card className="bg-emerald-500/5 border-none shadow-none">
                    <CardHeader className="pb-2">
                        <CardDescription className="text-[10px] uppercase font-bold tracking-widest text-emerald-600/70">Active Educators</CardDescription>
                        <CardTitle className="text-2xl font-black">{teachers.filter(t => t.status === 'Active').length}</CardTitle>
                    </CardHeader>
                </Card>
                <Card className="bg-rose-500/5 border-none shadow-none">
                    <CardHeader className="pb-2">
                        <CardDescription className="text-[10px] uppercase font-bold tracking-widest text-rose-600/70">Unique Subjects</CardDescription>
                        <CardTitle className="text-2xl font-black">{Array.from(new Set(teachers.flatMap(t => t.subjects))).length}</CardTitle>
                    </CardHeader>
                </Card>
            </div>

...
import { useExams, ExamType, ExamStatus } from "@/context/exam-context";
...
export default function AddExamPage() {
    ...
    async function onSubmit(values: z.infer<typeof formSchema>) {
        ...
        try {
            ...
            alert(`Failed to save exam: ${error.message || "Unknown error"}`);
        } finally {
            setIsSaving(false);
        }
    }
        ...
        <div className="max-w-2xl mx-auto py-6">
            ...
            <Card>
                <CardHeader>
                    ...
                    <CardDescription>Create a new examination schedule for a class</CardDescription>
                </CardHeader>
                <CardContent>
                    <Form {...form}>

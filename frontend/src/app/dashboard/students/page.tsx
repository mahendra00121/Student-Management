        ...
        <div className="flex flex-col gap-3">
            <header className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-lg font-bold tracking-tight uppercase">Student Directory</h1>
                        <p className="text-muted-foreground text-[10px] font-bold opacity-70">Manage and monitor all students registered in the academy.</p>
                    </div>
                </div>
                <div className="flex items-center gap-2">
